  ...
  return (
    <div className="overview-page">
      ...
      <div className="overview-stats-row">
        ...
        <div className="overview-stat-card overview-stat-dark">
          <div className="overview-stat-header">
      ...
      <div className="overview-main-grid">
        <div className="overview-left-col">
          <div className="overview-card attention-card">
            ...
            <button className="overview-footer-btn">View All Team Members (42)</button>
          </div>
        </div>
        ...
        <div className="overview-right-col">
          ...
          <div className="overview-card leaderboard-card">
            ...
            <button className="overview-footer-btn">Full Incentive Dashboard</button>
          </div>
        </div>
      </div>
      ...
      {showAssignModal && (
        <div className="overview-modal-overlay">
          <div className="overview-modal">
            ...
            <p>Task assignment form goes here.</p>
            <button className="overview-btn-outline" onClick={() => setShowAssignModal(false)}>Close</button>
          </div>
        </div>
      )}
    </div>
