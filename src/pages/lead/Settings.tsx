          ...
          <Card>
            ...
            <div style={{ padding: '0 24px 24px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ borderBottom: '1px solid var(--color-line)', paddingBottom: 12 }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--color-ink-soft)', textTransform: 'uppercase', tracking: '0.5px' }}>Assigned Role</div>
                <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--color-ink)', marginTop: 4 }}>Team Lead</div>
              </div>

              <div style={{ borderBottom: '1px solid var(--color-line)', paddingBottom: 12 }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--color-ink-soft)', textTransform: 'uppercase', tracking: '0.5px' }}>Department</div>
                <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--color-ink)', marginTop: 4 }}>GST Compliance</div>
              </div>

              <div style={{ borderBottom: '1px solid var(--color-line)', paddingBottom: 12 }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--color-ink-soft)', textTransform: 'uppercase', tracking: '0.5px' }}>Direct Reports</div>
                <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--color-ink)', marginTop: 4 }}>12 Active Members</div>
              </div>

              <div style={{ borderBottom: '1px solid var(--color-line)', paddingBottom: 12 }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--color-ink-soft)', textTransform: 'uppercase', tracking: '0.5px' }}>Managed Clients</div>
                <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--color-ink)', marginTop: 4 }}>4 Enterprise Accounts</div>
              </div>

              <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--color-ink-soft)', textTransform: 'uppercase', tracking: '0.5px' }}>Monthly Team Compliance Score</div>
